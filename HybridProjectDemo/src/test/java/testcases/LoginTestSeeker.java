...
public class LoginTestSeeker extends Page {
	...
	public void test(String id, String pwd) throws Exception {
		...
		if (actmsg != null) {
			Connection con = POIConfig.makeConnection("d:\\corejava\\Book2.xls"); // have to make connection as before
	...
	public static Object[][] getData() throws Exception {
		...
		return utility.POIConfig.getData("d:\\corejava\\Book2.xls", "Sheet1");
	}
